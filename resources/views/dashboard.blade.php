                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <p class="text-muted mb-0 text-truncate">Total Project</p>
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <p class="text-muted mb-0 text-truncate">Total Progress</p>
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <p class="text-muted mb-0 text-truncate">Total Estimasi Produksi</p>
